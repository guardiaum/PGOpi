...
# CHANGE IT
params_id_select = {'Dense': 0, 'dense_2': 1, 'dense_3': 1, 'fc_number': 0, 'gamma': 0, 'lstm_units': 1}
...
for iteration in range(1, repetitions + 1):
    ...
    out_ = Dense(params_chosen['Dense'], activation='relu', name='dense')(sentence_)
    ...
    y_prob_test = model.predict([test_sentences])
    ...
    y_prob_test_amzn = model.predict([test_sentences_amzn])
