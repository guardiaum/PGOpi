...
# CHANGE IT
params_id_select = {'Dense': 1, 'dense_2': 1, 'dense_3': 3, 'fc_number': 0, 'gamma': 1, 'lstm_units': 2}
...
for iteration in range(1, repetitions + 1):
    ...
    out_ = Dense(params_chosen['Dense'], activation='relu', name='dense')(aspect_)
    ...
    y_prob_test = model.predict([test_aspect])
    ...
    y_prob_test_amzn = model.predict([test_aspect_amzn])
